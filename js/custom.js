(function ($) {
	...
	var mainWindow = $(window),
		...
		serviceitemCarousel = $('.service-item'),
		workitemCarousel = $('.work-item'),
		priceitemCarousel = $('.price-item'),
		doctoritemCarousel = $('.doctor-item'),
		latestnewsCarousel = $('.latest-news'),
	...
	mainWindow.on('load', function () {
		...
		serviceitemCarousel.owlCarousel({
			loop: true,
			autoplay: true,
			margin: 15,
			dots: true,
		...
		// Carousel - Doctor Item
		doctoritemCarousel.owlCarousel({
			loop: true,
			autoplay: true,
			margin: 15,
			dots: true,
